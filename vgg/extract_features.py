...
parser.add_argument('--caffe',
                    default=os.path.expanduser('~/code/caffe'),
                    help='path to caffe installation')
parser.add_argument('--model_def',
                    default='VGG_ILSVRC_16_layers_deploy.prototxt',
...
def predict(in_data, net):
    ...
    features = net.blobs[args.layer].data
    return features
...
def batch_predict(filenames, net):
    ...
    F = net.blobs[args.layer].data.shape[1]
    Nf = len(filenames)
